...
import { $, add, addClass, append, attr, children, closest, css, data, each, eq, filter, find, hasClass, html, index, is, next, nextAll, off, offset, on, outerHeight, outerWidth, parent, parents, prepend, prev, prevAll, remove, removeAttr, removeClass, styles, text, toggleClass, transform, transition as transition$1, transitionEnd as transitionEnd$1, trigger } from 'dom7/dist/dom7.modular'
import { document as document$1, window } from 'ssr-window'
...
function getBreakpoint(breakpoints) {
  ...
  points.sort((a, b) => Number.parseInt(a, 10) - Number.parseInt(b, 10))
